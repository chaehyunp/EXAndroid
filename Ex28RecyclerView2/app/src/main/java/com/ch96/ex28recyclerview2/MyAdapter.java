...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.VH> { //generic표시 <MyAdapter.VH>
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        //VH객체가 가지고 있는 자식뷰들에 아이템의 값 설정(연결)
    ...
    //아이템뷰 1개 안에 있는 자식뷰들의 참조변수를 저장하고 있는 이너클래스
    class VH extends RecyclerView.ViewHolder {
        ...
        //상속받은 ViewHolder가 itemView의 값을 받기때문에 VH도 받아야함
